...
<head>
    ...
    <title>Login — UniTransport</title>
...
<div class="auth-page">
    <div class="auth-card">
        <div class="auth-header">
            <div class="auth-logo"><i class="fas fa-bus"></i></div>
            <h1>Welcome Back</h1>
            <p>Sign in to your UniTransport account</p>
        </div>
        ...
        <form method="POST" action="">
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-control" placeholder="you@university.ac.mw" value="<?= sanitize($_POST['email'] ?? '') ?>" required>
            </div>
