    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <?php if (isAdmin()): ?>
                ...
                <a href="<?= isset($isAdmin) ? 'dashboard.php' : 'admin/dashboard.php' ?>" class="nav-link <?= $currentPage === 'dashboard.php' && isset($isAdmin) ? 'active' : '' ?>">
                    <i class="fas fa-chart-pie"></i> Dashboard
                </a>
                <a href="<?= isset($isAdmin) ? 'manage_cars.php' : 'admin/manage_cars.php' ?>" class="nav-link <?= $currentPage === 'manage_cars.php' ? 'active' : '' ?>">
                    <i class="fas fa-car"></i> Manage Cars
                </a>
                <a href="<?= isset($isAdmin) ? 'manage_bookings.php' : 'admin/manage_bookings.php' ?>" class="nav-link <?= $currentPage === 'manage_bookings.php' ? 'active' : '' ?>">
                    <i class="fas fa-calendar-check"></i> All Bookings
                </a>
                <a href="<?= isset($isAdmin) ? 'manage_users.php' : 'admin/manage_users.php' ?>" class="nav-link <?= $currentPage === 'manage_users.php' ? 'active' : '' ?>">
            ...
            <a href="<?= isset($isAdmin) ? '../dashboard.php' : 'dashboard.php' ?>" class="nav-link <?= $currentPage === 'dashboard.php' && !isset($isAdmin) ? 'active' : '' ?>">
                <i class="fas fa-th-large"></i> My Dashboard
            </a>
            <a href="<?= isset($isAdmin) ? '../booking.php' : 'booking.php' ?>" class="nav-link <?= $currentPage === 'booking.php' ? 'active' : '' ?>">
        ...
        <div class="sidebar-footer">
            ...
            <a href="<?= isset($isAdmin) ? '../logout.php' : 'logout.php' ?>" class="btn btn-logout">
    ...
    <main class="main-content">
        <header class="top-bar">
            ...
            <div class="top-bar-right">
                <span class="greeting">Hello, <?= sanitize(explode(' ', $_SESSION['full_name'])[0]) ?></span>
            </div>
        </header>
